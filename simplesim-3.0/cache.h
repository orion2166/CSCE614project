...
enum cache_policy {
  ...
  HP_SRRIP,     /* replace using HP-SRRIP strategy */
  FP_SRRIP,     /* replace using FP-SRRIP strategy */
  DRRIP         /* replace using DRRIP strategy */
};
...
struct cache_blk_t
{
  ...
  int re_reference_value;       /* Block re-reference interval value */
};
